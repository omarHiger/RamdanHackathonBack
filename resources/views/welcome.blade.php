        ...
        <div class="card mb-5">
            <div class="card-body p-3">
                <div class="row">
                    ...
                    <div class="w-25">
                        <a type="button" href="{{route('register')}}" class="btn btn-primary mb-1 me-3">سجل الآن</a>
                ...
                <div class="row" id="donors">
                    ...
                    <div class="col-md-6 d-flex d-sm-flex d-md-flex justify-content-center align-items-center justify-content-md-start align-items-md-center justify-content-xl-center">
                        <div style="max-width: 500px;">
                            ...
                            <a href="{{route('register')}}" class="btn btn-primary">تبرع الآن</a>
                        </div>
                    </div>
                </div>
                <div class="row" id="menotor">
                    <div class="col-md-6 d-flex d-sm-flex d-md-flex justify-content-center align-items-center justify-content-md-start align-items-md-center justify-content-xl-center">
                        <div style="max-width: 500px;">
                            ...
                            <a href="{{route('register')}}" class="btn btn-primary">إنضم إلينا الآن </a>
                        </div>
                    </div>
                    <div class="col-md-6">
