            ...
            <form id="update-settings" action="{{ route('avatar.update') }}" enctype="multipart/form-data"
                ...
                <div class="app-modal-body">
                    ...
                    <div class="avatar av-l upload-avatar-preview chatify-d-flex"
                         style="background-image: url('{{ Chatify::getUserWithAvatar(Auth::guard('youth')->user())->avatar }}');"
                    ></div>
                    ...
                    <p class="app-modal-header">{{Auth::guard('youth')->user()->first_name . ' '.Auth::guard('youth')->user()->last_name}}
                    </p>

                    {{-- Dark/Light Mode  --}}
                    <p class="divider"></p>
                    <p class="app-modal-header">Dark Mode <span class="
                        {{ Auth::guard('youth')->user()->dark_mode > 0 ? 'fas' : 'far' }} fa-moon dark-mode-switch"
                                                                data-mode="{{ Auth::guard('youth')->user()->dark_mode > 0 ? 1 : 0 }}"></span>
                    </p>
